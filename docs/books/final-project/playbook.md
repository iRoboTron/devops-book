...
Тип проекта: **чистый production-сервер**.

Начинай с новой Ubuntu Server 22.04/24.04 или с чистого снапшота. Этот playbook не является продолжением итоговых проектов книг 2-6: он заново собирает весь production-стек.

До начала должно быть:
- root-доступ к серверу;
- домен с A-записью на IP сервера;
- GitHub-репозиторий с Python-приложением;
- токен GitHub для GHCR;
- Telegram bot token и chat_id;
- Backblaze B2 bucket или другой S3-compatible storage.
