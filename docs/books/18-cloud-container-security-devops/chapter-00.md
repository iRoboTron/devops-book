...
Связать cloud perimeter, IAM, secrets, hardening образов и runtime-защиту в единую картину для одного VPS и для кластеров.
...
Какие активы и доверительные границы появляются в cloud и контейнерах.
