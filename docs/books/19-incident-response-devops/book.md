# Обнаружение, мониторинг и Incident Response: Сигналы, triage и восстановление
...
- [**Глава 0: Что считать инцидентом**](chapter-00.md)
  - Событие, alert, incident, severity и цена неправильной реакции.
...
- [**Глава 3: Обнаружение на уровне хоста**](chapter-03.md)
...
- один VPS или пара VM, где уже есть публичный сервис;
- small business, где нет отдельной SOC-команды;
- команды, у которых есть логи и бэкапы, но нет понятного порядка действий при инциденте;
- все, кто хочет перейти от «увидели ошибку в логах» к нормальной инженерной реакции.
...
*Обнаружение, мониторинг и Incident Response: Сигналы, triage и восстановление — Курс Security Engineering, Модуль 19*
